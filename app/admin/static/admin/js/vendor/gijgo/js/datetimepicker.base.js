...
gj.datetimepicker.methods = {
    ...
    initialize: function (picker, data) {
        ...
        // TODO MODIFICATION
        calendarMode.classList.add("material-icons");
        calendarMode.classList.add('clickable');
        calendarMode.classList.add('selected');
        calendarMode.setAttribute('role', 'calendarMode');
        // calendarMode.innerHTML = 'event';
        // TODO MODIFICATION
        calendarMode.innerHTML = "calendar_today";
        ...
        // TODO MODIFICATION
        clockMode.classList.add("material-icons");
        clockMode.classList.add('clickable');
        clockMode.setAttribute('role', 'clockMode');
        // clockMode.innerHTML = 'clock';
        // TODO MODIFICATION
        clockMode.innerHTML = "access_time";
